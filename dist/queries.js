...
const sets = await fs.readTextFile(path.join(__dirname, "queries", "setsData.gql"));
const tourneysSmall = await fs.readTextFile(path.join(__dirname, "queries", "tournamentDataSmall.gql"));
const tourneys = await fs.readTextFile(path.join(__dirname, "queries", "tournamentData.gql"));
